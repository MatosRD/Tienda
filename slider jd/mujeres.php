...
?>
    ...
    <div class="encabezado">
        ...
        <h4> Hombre - <button>Mujere</button> -  Niño</h4>  
    </div>    
    ...
    $buscar_m = "SELECT * FROM mujeres";
    $realizar_1 = mysqli_query($conexion, $buscar_m);
    
    if(mysqli_num_rows($realizar_1) > 0 ){
        
        while($fila_m = mysqli_fetch_assoc($realizar_1)){?>
            <div class="cont_catalogo"><img style="max-height: 300px" src="data:image/jpg;base64,<?php echo "".base64_encode($fila_m['imagen']); ?>" > 
            <?php  echo'<div class="nombre">';    echo $fila_m['nombre']; echo'</div>';
            echo'<div class="descripcion">';  echo $fila_m['descripcion']; echo'</div>';
            echo'<div class="precio">';  echo '$'.$fila_m['precio'].' RD'; echo'</div>';
            echo " <a href='carrito_m.php?id=".$fila_m['id_producto']." ' > Carrito </a>";
            echo'</div>  ';
