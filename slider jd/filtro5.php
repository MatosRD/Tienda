...
?>
    ...
    <div class="catalogo_0"> 
        <div class="catalogo_01" >
            ...
            <hr></hr>
            <h5>Color</h5>
            <a href=""><button>Negro <div id="negro" ></div></button></a> 
            <a href=""><button>Blanco <div id="blanco" ></div></button></a> 
            <a href=""><button>Rosado   <div id="rosa" ></div></button></a> 
            <a href=""><button>Azul <div id="azul" ></div> </button></a> 
            <br> 
            <div class="space"></div>
...
$as = "SELECT * FROM ninos WHERE precio  >=  '3000 ' and precio <= '3500'";
...
$as = "SELECT * FROM mujeres WHERE precio  >=  '3000 ' and precio <= '3500'";
$ad = mysqli_query($conexion, $as);
if(mysqli_num_rows($ad) > 0 ){
    while($one = mysqli_fetch_assoc($ad)){ ?>
...
$as = "SELECT * FROM producto WHERE precio  >=  '3000 ' and precio <= '3500'";
$ad = mysqli_query($conexion, $as);
if(mysqli_num_rows($ad) > 0 ){
    while($one = mysqli_fetch_assoc($ad)){ ?>
        <div class="filtro_1"><img style="max-height: 300px" src="data:image/jpg;base64,<?php echo "".base64_encode($one['imagen']); ?>" >
